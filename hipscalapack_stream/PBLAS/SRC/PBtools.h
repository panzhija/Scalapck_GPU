...
void           hipPB_CpgemmAB     ( PBTYP_T *, char *,    char *,
                                 char *,    char *,    int,
                                 int,       int,       char *,
                                 char *,    int,       int,
                                 int *,     char *,    int,
                                 ...
                                 char *,    int,       int,
                                 int * );
void           hipPB_CpgemmAC     ( PBTYP_T *, char *,    char *,
                                 char *,    char *,    int,
                                 int,       int,       char *,
                                 char *,    int,       int,
                                 int *,     char *,    int,
                                 ...
                                 char *,    int,       int,
                                 int * );
void           hipPB_CpgemmBC     ( PBTYP_T *, char *,    char *,
                                 char *,    char *,    int,
                                 int,       int,       char *,
                                 char *,    int,       int,
                                 int *,     char *,    int,
...
char *         hipPB_Cmalloc      ( int );
char *         PB_Cgetbuf      ( char *,    int );

PBTYP_T *      hipPB_Citypeset    ( void );
PBTYP_T *      hipPB_Cstypeset    ( void );
PBTYP_T *      hipPB_Cdtypeset    ( void );
PBTYP_T *      hipPB_Cctypeset    ( void );
PBTYP_T *      hipPB_Cztypeset    ( void );
...
void           hipPB_CInV         ( PBTYP_T *, char *,    char *,
                                 int,       int,       int *,
                                 int,       char *,    int,
                                 int,       int *,     char *,
                                 char * *,  int *,     int * );
void           hipPB_CInV2        ( PBTYP_T *, char *,    char *,
                                 int,       int,       int *,
                                 int,       char *,    int,
                                 int,       int *,     char *,
                                 char *,    int,       int * );
...
void           PB_CInOutV2     ( PBTYP_T *, char *,    char *,
                                 ...
                                 char *,    char * *,  int *,
                                 int *,     int *,     int * );
void           hipPB_COutV        ( PBTYP_T *, char *,    char *,
                                 int,       int,       int *,
                                 int,       char * *,  int *,
                                 int *,     int * ,    int *);
...
PBTYP_T *      hipPB_Citypeset    ();
PBTYP_T *      hipPB_Cstypeset    ();
PBTYP_T *      hipPB_Cdtypeset    ();
PBTYP_T *      hipPB_Cctypeset    ();
PBTYP_T *      hipPB_Cztypeset    ();
...
inline bool __checkhipErrors(
                   
#ifdef __STDC__
void           PB_hipBLAS_Create();
void           PB_hipBLAS_Destroy();
void           PB_hipBLAS_Dgemm( int, int, int, char *, char *,
                                char *, int, char *, int,
                                char *, int );
#else
void           PB_hipBLAS_Create();
void           PB_hipBLAS_Destroy();
void           PB_hipBLAS_Dgemm();
#endif
#endif
#endif
